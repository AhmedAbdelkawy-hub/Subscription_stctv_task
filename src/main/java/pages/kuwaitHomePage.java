...
public class kuwaitHomePage {
	 WebDriver driver;


// create constructor
	public kuwaitHomePage(WebDriver driver) {
    ...
    By kuwait_CheckBox_Btn = By.id("kw");
    ...
    public void ClickOnKuwait_CheckboxCountry() {
        driver.findElement(kuwait_CheckBox_Btn).click();
    }
